...
urlpatterns=[
    path('sbi_customer_api/',views.employeeList.as_view()),
    path('sbi_admin_api/',views.admin_employeeList.as_view()),
    ...
    path('admin_form_submission',views.admin_form_submission,name='admin_form_submission'),
